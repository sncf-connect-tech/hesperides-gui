/* Original source: https://github.com/kineticsocial/angularjs-datetime-picker/blob/master/angularjs-datetime-picker.css
   MIT Licensed
 */
...
(function () {
    ...
    var datetimePickerPopup = function ($locale, dateFilter) {
        var days; var months; var daysOfWeek; var
            firstDayOfWeek;
        ...
        var getMonthView = function (year, month) {
            ...
            var leadingDays = (dayOfWeek - firstDayOfWeek + 7) % 7 || 7; // Ensure there are always leading days to give context
            var trailingDays = days.slice(0, 6 * 7 - (leadingDays + daysInMonth));
        ...
        var linkFunc = function (scope, element, attrs, ctrl) { // jshint ignore:line
            ...
            scope.updateNgModel = function (day) {
                ...
                if (attrs.ngModel) {
                    ...
                    var elScope = ctrl.triggerEl.scope(); var
                        dateValue;
        ...
        return {
            ...
            link(scope, element, attrs, ctrl) {
                ...
                scope.$watch(attrs.ngModel, function (value) {
                    ...
                    ctrl.$setValidity('date', Boolean(date));
                    var now = new Date();
                    if (attrs.hasOwnProperty('futureOnly')) {
                        ctrl.$setValidity('future-only', !(date < now));
                    }
                });
