var mod = angular.module ('hesperides.properties');
 ...
 */
mod.directive('iterablePropertiesContainer', [function (){
 ...
 */
.controller ('iterablePropertiesContainerController', ['$scope', function ($scope){
