 ...
 */
angular.module('hesperides.properties', [ 'hesperides.diff', 'hesperides.localChanges', 'hesperides.modals', 'cgNotify', 'hesperides.properties.logicGroup' ])
    ...
    .controller('PropertiesController', function ($scope, $routeParams, $mdDialog, $location, $route,
        ApplicationService, FileService, Module, ModuleService, ApplicationModule, Page, $translate,
