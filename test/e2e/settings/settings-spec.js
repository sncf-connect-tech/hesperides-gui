...
describe('Manage settings', () => {
    ...
    it('should not display instances of a platform by default (BOX MODE)', () => {
        expect(element.all(by.id(`e2e-instance-list-for-${ data.new_module_name }`)).count()).toEqual(0);
    });

    it('should display instances of a platform by default when the corresponding setting entry is set (BOX MODE)', () => {
